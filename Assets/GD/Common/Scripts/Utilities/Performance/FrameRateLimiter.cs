...
/// </summary>
/// <see cref="https://github.com/adammyhre/Unity-Utils/blob/master/UnityUtils/Scripts/FrameRateLimiter.cs"/>
public class FrameRateLimiter : MonoBehaviour
{
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.F5)) Application.targetFrameRate = 200;
    }
}